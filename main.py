...
Urban_Districts = ['30101 Gamle Oslo', '30102 Grünerløkka', '30103 Sagene', '30104 St.Hanshaugen', '30105 Frogner',
                   '30106 Ullern', '30107 Vestre Aker', '30108 Nordre Aker',
...
Grunnkrets = ['3012401 Tøyen Rode 1', '3012408 Tøyen Rode 8', '3012409 Tøyen Rode 9',
              '3012502 Grønland Rode 2', '3012503 Grønland Rode 3', '3012504 Grønland Rode 4',
              '3012505 Grønland Rode 5',
              '3012506 Grønland Rode 6', '3012507 Grønland Rode 7', '3012508 Grønland Rode 8',
              '3012509 Grønland Rode 9',
              ...
              '3011704 Bjølsen Rode 4', '3011705 Bjølsen Rode 5', '3011706 Bjølsen Rode 6', '3011707 Bjølsen Rode 7',
              '3011708 Bjølsen Rode 8', '3011801 Sandaker Rode 1', '3011803 Sandaker Rode 3',
              ...
              '3012011 Torshov Rode 11', '3012012 Torshov Rode 12', '3012102 Sinsen Rode 2',
              '3010201 Sentrum 2 - Rode 1',
              ...
              '3010401 Filipstad', '3010501 Skillebekk Rode 1', '3010502 Skillebekk Rode 2',
              '3010503 Skillebekk Rode 3',
...
map_type = dbc.RadioItems(
    options=[
        ...
        {"label": "Point Map", "value": 'size_map'},
...
map_style_menu = dcc.Dropdown(
    ...
    value='open-street-map', style=dict(color='black', textAlign='left',
...
navigation_header = dbc.Nav(
    [
        ...
        #dbc.NavItem(dbc.NavLink("Register", href="/Register", active='exact', id='Register',style=dict(fontSize=navbar_font_size))),
...
simulation_type_menu = dcc.Dropdown(
    ...
    value='Network', style=dict(color='black',textAlign='left',
                                width='20vh', backgroundColor='white', border='1px solid black')
)
# height='50px' ,
...
model_type_text = html.Div(html.H1('Transport Model:',
                                   style=dict(fontSize=text_font_size, fontWeight='bold', color='black',
                                              marginTop='1vh')),
...
model_type_menu = dcc.Dropdown(
    ...
    value='SIM', style=dict(color='black', textAlign='left'
                            , width='20vh', backgroundColor='white', border='1px solid black')
)
# display='inline-block',border='2px solid #082255',
...
city_menu = dcc.Dropdown(
    ...
    value='Urban', style=dict(color='black', textAlign='left',
                              width='20vh', backgroundColor='white', border='1px solid black')
)
# display='inline-block',border='2px solid #082255'
...
navigation_header2 = dbc.Nav(
    [
        ...
        dbc.NavItem(dbc.NavLink("Infographics", href="/Infographics", active='exact', id='Infographics',
                                style=dict(fontSize=navbar_font_size))),
        #dbc.NavItem(dbc.NavLink("Model Analysis", href="/Analysis", active='exact', id='Analysis',style=dict(fontSize=navbar_font_size))),
...
multiple_param = dbc.Button("Add Parameter(+)", color="primary", size='lg', n_clicks=0, id="multiple_param"
                            , style=dict(fontSize=text_font_size, width='20vh')
                            )
db_multiple_param = dbc.Col([html.Br(), multiple_param],
                            xs=dict(size=10, offset=1), sm=dict(size=10, offset=1),
                            md=dict(size=10, offset=1), lg=dict(size=2, offset=0), xl=dict(size=2, offset=0)
                            )
...
app.layout = html.Div([dbc.Row([db_logo_img, db_header_text], style=dict(backgroundColor='#2358a6')),
                       ...
                       dbc.Row([dbc.Col([
                           dbc.Container([dbc.Row(db_multiple_param), html.Div([], id='container'),
                                         ...
                                         style=dict(border='2px solid black', maxHeight='35vh', overflow='scroll'),
                                         fluid=True
                                         )
...
def update_existing_input(n_clicks, subdivision, parameter):
    ...
    elif parameter == 'Cost of Transport':
        return df[df['Destination'].str.contains(subdivision_name)]['Dist'].values[0]
...
@app.callback(
    ...
    [Input('multiple_param', 'n_clicks')],
    [State('container', 'children'), State('city_dropdown', 'value')]
)
def add_parameter(n_clicks, container_content, city_subdivision):
    subdivisions = []
    if city_subdivision == 'Urban':
        subdivisions = Urban_Districts
    elif city_subdivision == 'Grunnkrets':
    ...
    parameter_menu = dcc.Dropdown(
        ...
        options=[
            ...
            dict(label='Cost of Transport', value='Cost of Transport')

        ],
        value='Population', style=dict(color='black', textAlign='left',
                                       width='20vh', backgroundColor='white', border='1px solid black')
    )
    ...
    subdivision_menu = dcc.Dropdown(
        ...
        value=subdivisions[0], style=dict(color='black', textAlign='left',
                                          width='25vh', backgroundColor='white', border='1px solid black')
    )
    ...
    existing_param_input_div = html.Div([existing_input],
                                        style=dict(fontSize='1.7vh', marginLeft='1vh', marginBottom='-2vh',
    ...
    revised_param_input_div = html.Div([revised_input],
                                       style=dict(fontSize='1.7vh', marginLeft='1vh', marginBottom='-2vh',
                                                  display='inline-block'))
